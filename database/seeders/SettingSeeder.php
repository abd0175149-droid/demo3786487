...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            // بيانات الشركة
            ['key' => 'company_name_ar', 'value' => 'نظام إدارة الأعمال', 'group_name' => 'company', 'type' => 'string', 'description' => 'اسم الشركة بالعربي'],
            ['key' => 'company_name_en', 'value' => 'Business Management System', 'group_name' => 'company', 'type' => 'string', 'description' => 'اسم الشركة بالإنجليزي'],
